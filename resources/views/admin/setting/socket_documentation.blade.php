                                                    ...
                                                    <li class="documentation-body__list-item">
                                                        ...
                                                        <ul class="text-list">
                                                            ...
                                                            <li>@lang('Give an') <strong>@lang('Application Root')</strong> @lang('name as you like')
                                                                (@lang('e.g.'), <code>@lang('flurzi_socket')</code>).</li>
                                    ...
                                    <div class="changelog-container">
                                        ...
                                        <div class="changelog-right">
                                            <div class="changelog-right-content">
                                                <ul class="documentation-body__list">
                                                    <li class="documentation-body__list-item">
                                                        <strong> @lang('Step 4') : </strong> @lang('Already Created a folder in root : “flurzi_socket” check it out your panel root.')
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                                    ...
                                                    <li class="documentation-body__list-item">
                                                        ...
                                                        <ul class="text-list">
                                                            <li>@lang('Upload') <code>@lang('websocket.zip')</code> @lang('into the')
                                                                <code>@lang('flurzi_socket')</code> @lang('folder.')
                                                            </li>
                                                ...
                                                <ul class="documentation-body__list">
                                                    <li class="documentation-body__list-item">
                                                        ...
                                                        <ul class="text-list">
                                                            ...
                                                            <li><i class="las la-mouse"></i> <strong>@lang('Click') “@lang('Run NPM Install')”</strong> @lang('to install dependencies inside') <code>@lang('flurzi_socket')</code>.</li>
                                                            <li>@lang('Install dependencies') “@lang('node modules')” @lang('inside') <code> @lang('e.g. flurzi_socket')</code> @lang('folder.')</li>
                                                        </ul>
                                                    </li>
                                                    ...
                                                    <li class="documentation-body__list-item">
                                                        ...
                                                        <ul class="text-list">
                                                            ...
                                                            <li>@lang('Replace the URI with your App URI:')
                                                                <br />
                                                                <code>@lang('wss://example.com/flurzi_socket')</code>
                                                                <br />
                                                                @lang('or')
                                                                <br />
                                                                <code>@lang('ws://example.com/flurzi_socket')</code>
                                                            </li>
