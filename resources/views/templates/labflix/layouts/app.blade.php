...
<head>
  ...
  <title>Flurzi Cinema</title>
   ...
   <!-- <link type="image/png" href="{{ siteFavicon() }}" rel="icon" sizes="16x16"> -->
    ...
    <link rel="icon" href="{{ asset('assets/images/favicon.png') }}" sizes="18x18">
...
<body @stack('context') style="background:#0b0b0f; color:#fff;"> 
    ...
    <div class="page-wrapper" id="main-scrollbar" data-scrollbar>
        @if (@$type != 'app')
            ...
            @if (!request()->routeIs('short.videos'))
                ...
                @if (!in_array(request()->route()->getName(), ['home', 'contact', 'user.login', 'user.register' , 'live.tv', 'live.tournaments', 'tournament.detail', 'game.detail', 'short.videos']))
